...
using Defender.IdentityService.Application.Configuration.Extension;
                ...
                options.TokenValidationParameters = new TokenValidationParameters()
                {
                    ...
                    IssuerSigningKey = new SymmetricSecurityKey(
                        Encoding.UTF8.GetBytes(
                            SecretsHelper.GetSecretAsync(Secret.JwtSecret).Result
                        )
                    ),
                };
            });
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            options.SwaggerDoc(
                ...
                new OpenApiInfo
                {
                    ...
                    Description =
                        "Service to manage generate jwt token and manage accounts authorization info",
                }
            );
